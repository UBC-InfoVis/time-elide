...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Select slicing method";
    			toggle_class(div, "disabled", /*disabled*/ ctx[0]);
    			add_location(div, file, 12, 0, 70);
    		},
    ...
    const file$1 = "src/VisTypeSelector.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Select visualization type";
    			toggle_class(div, "disabled", /*disabled*/ ctx[0]);
    			add_location(div, file$1, 12, 0, 70);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$2, 17, 0, 355);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/DataSourcePage.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 79, 4, 1690);
    			attr_dev(span0, "uk-icon", "icon: cloud-upload");
    			add_location(span0, file$3, 82, 6, 1774);
    			attr_dev(span1, "class", "uk-text-middle");
    			add_location(span1, file$3, 83, 6, 1823);
    			attr_dev(input, "type", "file");
    			add_location(input, file$3, 85, 8, 1916);
    			attr_dev(span2, "class", "uk-link");
    			add_location(span2, file$3, 86, 8, 1944);
    			attr_dev(div0, "uk-form-custom", "");
    			add_location(div0, file$3, 84, 6, 1887);
    			attr_dev(div1, "class", "js-upload uk-placeholder uk-text-center");
    			add_location(div1, file$3, 81, 4, 1714);
    			add_location(button0, file$3, 90, 4, 2013);
    			add_location(button1, file$3, 93, 4, 2118);
    			add_location(div2, file$3, 77, 2, 1677);
    			attr_dev(div3, "class", "uk-padding-small uk-width-expand");
    			add_location(div3, file$3, 76, 0, 1628);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class DataSourcePage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { dataSourceUrl: 0 });
    ...
    const file$4 = "src/VisPage.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 12, 2, 122);
    			attr_dev(div, "class", "uk-padding-small");
    			add_location(div, file$4, 10, 0, 84);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class VisPage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { showDataSourcePage: 0 });
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 53, 2, 1139);
    			add_location(main, file$5, 51, 0, 1125);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { name: 3 });
